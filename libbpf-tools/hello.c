...
/*
 * hello	Trace process termination.
 *
 * Copyright (c) 2021 Hengqi Chen
 *
 * Based on hello(8) from BCC by Arturo Martin-de-Nicolas & Jeroen Soeters.
...
const char *argp_program_version = "hello 0.1";
const char *argp_program_bug_address =
	"https://github.com/iovisor/bcc/tree/master/libbpf-tools";
const char argp_program_doc[] =
"Trace process termination.\n"
"\n"
"USAGE: hello [-h] [-t] [-x] [-p PID] [-T]\n"
"\n"
"EXAMPLES:\n"
"    hello             # trace process exit events\n"
"    hello -t          # include timestamps\n"
"    hello -x          # trace error exits only\n"
"    hello -p 1216     # only trace PID 1216\n"
"    hello -T          # trace by thread\n";
